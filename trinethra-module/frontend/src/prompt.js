export const generatePrompt = (transcript) => {
  return `Analyze the following supervisor transcript(s) for a Design Thinking (DT) fellow assessment using the TRINETHRA methodology.
